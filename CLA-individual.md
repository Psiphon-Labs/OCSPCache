...
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please submit a pull request with a file under the `/contributors` directory indicating your acceptance of this agreement, following the instructions at https://github.com/Psiphon-Labs/OCSPCache/blob/master/CONTRIBUTING.md.
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://github.com/Psiphon-Labs/OCSPCache/blob/master/CONTRIBUTING.md.
...
(d) You have followed the instructions in https://github.com/Psiphon-Labs/OCSPCache/blob/master/CONTRIBUTING.md, if You do not own the Copyright in the entire work of authorship Submitted.
